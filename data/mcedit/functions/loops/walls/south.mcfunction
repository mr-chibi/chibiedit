...
#
data modify entity @s[tag=step1,tag=step2,tag=layer] Tags set value ["walls", "walls_south", "layer"]
data modify entity @s[tag=step1,tag=step2,tag=!layer] Tags set value ["walls", "walls_south"]
...
# Pause:
#######################################################################################
execute if entity @a[team=mcedit,nbt=!{SelectedItem:{id:"minecraft:carrot_on_a_stick"}}] run data modify entity @s[tag=step3] Tags set value ["walls", "walls_south", "pause"]


#######################################################################################
# Override and continue:
#######################################################################################
execute if entity @a[team=mcedit,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick"}}] run data modify entity @s[tag=step3] Tags set value ["walls", "walls_south", "layer"]
