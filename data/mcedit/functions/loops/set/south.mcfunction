#
execute if score @s set_z < @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_z run tp @s[tag=!step1] ~ ~ ~1
execute if score @s set_y < @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_y if score @s set_z = @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_z run tp @s[tag=!step1] ~ ~1 ~0.5
execute if score @s set_y > @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_y if score @s set_z = @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_z run tp @s[tag=!step1] ~ ~-1 ~0.5
execute if score @s set_z = @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_z run tag @s add step1

#
execute if score @s set_z > @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_z run tp @s[tag=step1,tag=!step2] ~ ~ ~-1
execute if score @s set_y < @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_y if score @s set_z = @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_z run tp @s[tag=step1,tag=!step2] ~ ~1 ~-0.5
execute if score @s set_y > @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_y if score @s set_z = @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_z run tp @s[tag=step1,tag=!step2] ~ ~-1 ~-0.5
execute if score @s set_z = @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_z run tag @s[tag=step1,tag=!step2] add step2


#
data modify entity @s[tag=step1,tag=step2] Tags set value ["set", "set_south"]
