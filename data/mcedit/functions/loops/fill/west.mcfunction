#
execute if score @s fill_x > @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_x run tp @s[tag=!step1] ~-1 ~ ~
execute if score @s fill_x = @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_x run tp @s[tag=!step1] ~ ~ ~-1
execute if score @s fill_x = @e[type=minecraft:armor_stand,tag=pos2,limit=1] pos2_x run tag @s add step1

#
execute if score @s fill_x < @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_x run tp @s[tag=step1,tag=!step2] ~1 ~ ~
execute if score @s fill_x = @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_x run tp @s[tag=step1,tag=!step2] ~ ~ ~-1
execute if score @s fill_x = @e[type=minecraft:armor_stand,tag=pos1,limit=1] pos1_x run tag @s[tag=step1,tag=!step2] add step2

#
data modify entity @s[tag=step1,tag=step2] Tags set value ["fill", "fill_west"]
...
#
data modify entity @s[tag=step3] Tags set value ["fill", "fill_west"]
